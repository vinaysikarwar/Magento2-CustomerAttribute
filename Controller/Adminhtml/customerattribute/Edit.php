...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('WebTechnologyCodes_CustomerAttribute::Customerattribute')
            ->addBreadcrumb(__('WebTechnologyCodes CustomerAttribute'), __('WebTechnologyCodes CustomerAttribute'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('WebTechnologyCodes\CustomerAttribute\Model\Customerattribute');
        ...
        $this->_coreRegistry->register('customerattribute', $model);
